...
$modules = array(
  ...
  array(
    ...
    'version' => array(
      ...
      'security' => true,
      'compatible' => '*',
      'note' => 'Sensitive data exposure from API endpoint',
      'zip' => 'https://raw.githubusercontent.com/BoidCMS/Packages/master/plugin/api/0.1.1.zip'
    ),
    'dependencies' => array(),
    'files' => [
      'plugin.php'
  ...
  array(
    ...
    'slug' => 'cron',
    'name' => 'CRON',
    'description' => 'Manage CRON Jobs Effortlessly With Easy Scheduling and Automation',
    'website' => 'https://boidcms.github.io/#/plugins/cron',
    'author' => 'Shuaib Yusuf Shuaib',
    'keywords' => 'Dev, Task, Workflow',
    'license' => 'MIT',
